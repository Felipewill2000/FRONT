...
import { CommonModule } from '@angular/common'; // CommonModule incluye pipes comunes como currency
...
@NgModule({
  ...
  imports: [
    ...
    CommonModule // Añadido CommonModule para pipes comunes como currency
  ],
  providers: [
